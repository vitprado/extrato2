...
public class TratoDAO {
    ...
    public Trato adicionarTrato(Trato trato) throws Exception{
        return tratoController.create(trato);
    }

    public void editarTrato(Trato trato) throws Exception{
        tratoController.edit(trato);
    }

    public void removerTrato(Integer id) throws Exception{
        tratoController.destroy(id);
    }
